    ...
    <div class="left-box text-center">
        ...
        <form method="post" action="">
            <div class="mb-3 text-start">
                <label for="dsr_no" class="form-label">DSR Item No.</label>
                <input type="text" class="form-control" id="dsr_no" name="dsr_no" 
                    placeholder="Enter DSR No." required 
                    autocomplete="off">
            </div>
            <div class="mb-3 text-start">
            ...
            <button type="submit" class="btn btn-primary w-50" name="add_item">
        ...
        <div class="mb-3 text-start">
            ...
            <input type="text" class="form-control" id="delete_dsr_no" name="delete_dsr_no" 
                placeholder="Enter DSR No. to be Deleted" required 
                autocomplete="off" autocorrect="off" spellcheck="false">
        </div>


            <button type="submit" class="btn btn-danger w-50" name="delete_item">
        ...
        <!-- Add Non-Schedule Item Button -->
        <form method="post" action="MRitem.php">
            
            <button type="submit" class="btn btn-success w-100" name="add_non_schedule">
                <i class="fas fa-file-alt"></i> Add Non-Schedule Item
            </button>
        </form>
    </div>
