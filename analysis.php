...
<body>
    ...
    <div class="container mt-5">
        ...
        <h2 class="text-center fw-bold" style="font-size: 3rem; letter-spacing: 2.5px; color: #007bff; text-decoration: underline;">
            <i class="fas fa-file-alt"></i> Justification
        </h2>
            ...
            <form method="POST">
                <div class="mb-3">
                    <label for="nit_no" class="form-label fw-bold">
                        <i class="fas fa-list-alt"></i> Select NIT Number for Justification
                    </label>
                ...
                <div class="mb-3">
                    <label for="nit_saved" class="form-label fw-bold">
                        <i class="fas fa-copy"></i> Copy existing Market Rates from NIT No. (Optional)
                    </label>
                    <select name="nit_saved" id="nit_saved" class="form-select border-primary shadow-sm">
                        <option value="" disabled selected>Select NIT No. for copying (Optional)</option>
                        <?php foreach ($nit_list as $nit): ?>
                            <option value="<?= htmlspecialchars($nit); ?>">
                                <?= htmlspecialchars($nit); ?>
                            </option>
                ...
                <button type="submit" name="start_analysis" class="btn btn-primary px-4 py-2 shadow">
                    <i class="fas fa-play-circle"></i> Start Justification
                </button>
                </div>
            </form>
        </div>
...
<?php endif; ?>
    ...
    <?php if ($analysis_started && !empty($nit_no)): ?>
        ...
        <?php 
        //echo "<div class='text-center fw-bold text-primary' style='font-size: 3rem; letter-spacing: 1.5px; margin-top: 20px; margin-bottom: -35px; text-decoration: underline;'>
          //      NIT No.- $nit_no
            //</div>";
        ?>
        <div class="container mt-5">
            ...
            <?php 
                echo "<div class='text-center fw-bold' style='font-size: 3rem; letter-spacing: 1.5px; margin-top: 0px; margin-bottom: 10px; text-decoration: underline; color: #111111;'>
                    NIT No.- $nit_no
                </div>";
            ?>
          <h2 class="fw-bold" style="margin-bottom: -45px; font-size: 2.4rem; letter-spacing: 1.5px; color: #111111;">
                Provide Market Rates
            </h2>
            ...
            <?php if (count($data_MR) > 0): ?>
                <form method="POST"> <!-- Form submission to save data -->
                    ...
                    <button type="submit" name="submit_market_rates" class="btn" style="background-color: #155724; color: white; border: none;">
                        Submit
                    </button>
                </form>
            <?php endif; ?>
